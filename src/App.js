      ...
      <div>
          ...
          <Switch>
            <Route exact path='/' render={
              ()=>{
                if(this.state.currentUser && this.state.currentUser.uid === 'Bml5ta0t2FVG9mq75haLIfq6Luk1')
            ...
            <Route exact path='/admin-panel' render={()=>!this.state.currentUser?(<Redirect to='/'/>):<AdminPanel/>}/>
            ...
            <Route exact path='/main-page' render={()=>!this.state.currentUser?(<Redirect to='/'/>):<MainPage/>}/>
